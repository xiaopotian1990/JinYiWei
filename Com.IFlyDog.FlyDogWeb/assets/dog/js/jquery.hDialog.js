...
; (function ($, window, document, undefined) {
    ...
    methods = {
        ...
        open: function (o, T) {
            ...
            //关闭按钮
            if (o.closeHide != false) closeBtnTpl = '<a id="HCloseBtn" title="关闭" style="width:24px;height:24px;line-height:24px;display:inline-block;cursor:pointer;background-color:' + closeBg + ';color:#fff;font-size:1.4em;text-align:center;position:absolute;top:8px;right:8px;"><span style="z-index:99999;width:24px;height:24px;display:inline-block;">×</span></a>';

            //弹框标题
            if (o.title != '') headTpl = '<div id="HTitle" style="padding:10px 45px 10px 12px;border-bottom:1px solid #ddd;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">' + o.title + '</div>';

            //遮罩背景层
            //if (o.isOverlay != false) overlayTpl = "<div id='HOverlay' style='width:100%;height:100%;background-color:" + modalBg + ";position:fixed;top:0;left:0;z-index:9999;'></div>";
	...
	*/
    $.extend({
        ...
        dialog: function (type, title, content, time, callback) {
            ...
            tpl += '<div id="hDialog-wrap" class="animated fadeIn" style="width:' + width + 'px;border-radius:5px;box-shadow:4px 4px 10px #666;-webkit-box-shadow:4px 4px 10px #666;border:1px solid #eee;position:fixed;top:35%;left:50%;margin:' + margin + ';z-index:100000;">' + headerTpl + contentTpl + footerTpl + '</div>';
