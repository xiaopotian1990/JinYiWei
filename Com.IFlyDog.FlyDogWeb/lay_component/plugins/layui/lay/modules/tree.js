                            ...
                            s = o(
                                [
                                    ...
                                    function () {
                                        ...
                                        return i.check && i.check === "checkbox"
                                            ? '<input type="checkbox" name="' +
                                            i.checkboxName + '" ' +
                                            ((n.Checked && n.Checked === true) ? 'checked="checked"' : "") +
                                            (n.ID ? ('value="' + n.ID + '"') : "") +
                                            'data-parent-id="' + n.PID + '"' + 'id="' + n.ID + '" lev="' + n.Lev + '"' + (i.checkboxStyle ? ('style="' + i.checkboxStyle + '"') : "") + " />" : "";
                                    }(),
                                    function () {
                                        return '<a href="' +
                                            (n.href || "javascript:;") +
            ...
            i.prototype.cancelParentsCheckboxCheck = function (ele) {
                ...
                if (!childrendInputs || childrendInputs.length == 0) {
                    ...
                    for (var j = 0, len2 = childrendInputs.length; j < len2; j++) {
                        ...
                        //childrendInputs[j].getAttribute("data-parent-id");
        ...
        //},
            ...
            i.prototype.spread = function (e, o) {
                var a = this,
                    ...
                    l = function () {
                        e.data("spread")
                            ? (e.data("spread", null), i.removeClass("layui-show"), r.html(t.arrow[0]), n
                                .find(".layui-icon").html(t.branch[0]))
                            : (e.data("spread", !0), i.addClass("layui-show"), r.html(t.arrow[1]), n.find(".layui-icon")
                                .html(t.branch[1]));
                    };
                    ...
                    i.drag &&
                        o(document).on("mousemove",
                            ...
                            function () {
                                var e = a.move;
                                e.from &&
                                (e.from.elem.children("a")
                                    .removeClass(r), e.to && e.to.elem.children("a").removeClass(r), a
                                    .move = {}, o("." + t).remove());
                            });
            },
            i.prototype.move = {},
