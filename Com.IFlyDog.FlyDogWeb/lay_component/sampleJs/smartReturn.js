$(function () {
    ...
    $(document).on("change propertychange keydown keyup", "#smartReturnDetailTD .layui-input", function () {
...
$("#smartReturnHtml")
    .ready(function () {
        var infoFunc = function () {
            var url = "/SmartReturn/SmartReturnGet";
            ...
            var interText = doT.template($("#smartReturn_template").text());
...
function aa() {
    var url = "/SmartReturn/SmartReturnGet";//测试查询及分页
    var cangkId = $("#smartWarehouse").val();
    var gongYSId = $("#smartSupplier").val();
    var beginDate = $("#beginDate").val();
    var endDate = $("#endDate").val();
